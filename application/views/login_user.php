						...
						<form action="<?= site_url('masuk_proc') ?>" method="post" accept-charset="utf-8">
							...
							<div class="row">
								<div class="col-sm-12">
									...
									<div class="input-group mb-0">
										<button type="button" onclick="window.location='<?= site_url('authdiv') ?>'" class="btn btn-outline-danger btn-lg btn-block">Login Perusahaan</button>
									</div>
								</div>
							</div>
						</form>
